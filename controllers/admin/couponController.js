...
const toggleCouponStatus = async (req, res) => {
    try {
      const couponId = req.params.id;
      const isList = req.body.isList === true; // Ensure boolean value
      
      console.log('Toggle request for coupon:', couponId, 'Set active to:', isList);
      ...
      console.log('Coupon updated successfully:', couponId, 'New status:', isList);
